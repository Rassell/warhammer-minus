...
TAG_RULES = [
    ...
    ('eldar', r'eldars?|aeldari|harlequins?|craftworlds?|fire dragons?|phoenixs?'),
    ...
    ('bases', r'bases?|base building|scenery|terrain|rocks?|ruins?|barricades?|cityscapes?|buildings?|trees?|grass|water effects?'),
    ...
    ('cloth', r'cloth|fabric|robes?|capes?|clothing|Leather|camo'),
